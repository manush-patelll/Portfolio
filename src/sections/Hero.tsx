...
export const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute top-[20%] left-[-10%] w-[300px] h-[300px] md:w-[500px] md:h-[500px] rounded-full bg-portfolioPrimary/10 blur-[80px] md:blur-[120px] -z-10 animate-pulse"
        style={{ animationDuration: "8s" }}
      />
      <div
        className="absolute bottom-[10%] right-[-10%] w-[300px] h-[300px] md:w-[500px] md:h-[500px] rounded-full bg-portfolioSecondary/10 blur-[80px] md:blur-[120px] -z-10 animate-pulse"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
        ...
        >
          ...
          <button
            onClick={() =>
              alert(
                "Resume will be uploaded shortly! Feel free to contact me directly.",
              )
            }
